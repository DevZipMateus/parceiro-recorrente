...
import familyImage from "/lovable-uploads/137ca610-ccce-4636-aba6-86908840d850.png";
      ...
      <div className="container max-w-6xl mx-auto px-4 md:px-6">
        <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center mb-8">
          <div className="relative order-2 lg:order-1">
            <img src={familyImage} alt="Família feliz planejando o futuro com estabilidade financeira e qualidade de vida" className="w-full h-auto rounded-2xl shadow-xl" />
          </div>
        ...
        </div>        <Card className="border-0 bg-white">
